...
predicate long_integer(long long *p; long long l);
predicate u_long_integer(unsigned long long *p; unsigned long long l);
...
predicate llongs(long long *p, long long count; list<long long> ls) = 
    count == 0 ?
        ls == nil
    :
        long_integer(p, ?l) &*& llongs(p + 1, count - 1, ?ls0) &*& ls == cons(l, ls0);
