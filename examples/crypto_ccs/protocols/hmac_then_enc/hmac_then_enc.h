...
predicate hmac_then_enc_pub_1(list<crypto_char> ccs, cryptogram cg) = true;
...
predicate hmac_then_enc_pub(cryptogram cg) =
  switch (cg)
  {
    ...
    case cg_encrypted(p0, c0, ccs0, ent0):
      return hmac_then_enc_public_key(p0, c0, true) ?
        [_]public_generated(hmac_then_enc_pub)(ccs0)
      :
        hmac_then_enc_pub_1(?msg_ccs, ?hmac_cg) &*&
        ccs0 == append(msg_ccs, ccs_for_cg(hmac_cg)) &*&
    ...
    case cg_asym_encrypted(p0, c0, ccs0, ent0):
      return [_]public_generated(hmac_then_enc_pub)(ccs0);
