...
//   //@ length_equals_nat_length(ccs);
//   //@ c_to_cc_inj(t, TAG_DATA);
//   //@ c_to_cc_inj(t, TAG_PAIR);
//   //@ c_to_cc_inj(t, TAG_NONCE);
//   //@ c_to_cc_inj(t, TAG_HASH);
//   //@ c_to_cc_inj(t, TAG_SYMMETRIC_KEY);
//   //@ c_to_cc_inj(t, TAG_PUBLIC_KEY);
//   //@ c_to_cc_inj(t, TAG_PRIVATE_KEY);
//   //@ c_to_cc_inj(t, TAG_HMAC);
//   //@ c_to_cc_inj(t, TAG_SYMMETRIC_ENC);
//   //@ c_to_cc_inj(t, TAG_ASYMMETRIC_ENC);
//   //@ c_to_cc_inj(t, TAG_ASYMMETRIC_SIG);
//   switch (t)
//   {
//     case TAG_DATA:
//       break;
