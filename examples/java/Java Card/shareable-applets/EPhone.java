...
public final class EPhone extends Applet {
    ...
    //@requires APDU(apdu,?buffer) &*& array_slice(buffer,0,buffer.length,_) &*& registered_applets(?as) &*& foreach(remove((Applet)this,as),semi_valid) &*& mem((Applet)this,as)==true &*& [1/2]valid();
    //@ensures APDU(apdu,buffer) &*& array_slice(buffer,0,buffer.length,_) &*& registered_applets(as) &*& foreach(remove((Applet)this,as),semi_valid) &*& [1/2]valid();
    {
        byte[] abuffer = apdu.getBuffer();
    ...
    //@requires 0 <= amount &*& amount <= max_transaction_amount &*& registered_applets(?as) &*& foreach(as,full_valid) &*& mem((Applet)this,as)==true &*& in_transaction(this, ?l);
    //@ensures registered_applets(as) &*& foreach(as,full_valid) &*& in_transaction(this, l);
    {
    	//@ foreach_remove((Applet)this,as);
        //@ open full_valid(this);
    	//@ open valid();
	...
	//@ close valid();
	  ...
	  //@ close full_valid(this);
          //@ foreach_unremove((Applet)this,as);
	  //@ close EInterface(EWallet.class)((EWallet)WalletInterface);  
          ...
          //@ open EInterface(EWallet.class)((EWallet)WalletInterface);
