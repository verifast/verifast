...
typedef lemma void atomic_integer_set_lemma(int new_value, predicate(int) I, int level)();
...
typedef lemma void atomic_integer_get_lemma(predicate(int) I, int level)();
...
typedef lemma void atomic_integer_cas_lemma(predicate(int) I, int old, int new, int level)();
...
typedef lemma void atomic_integer_inc_lemma(predicate(int) I, int level)();
