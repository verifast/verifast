...
bool string_buffer_split(struct string_buffer *buffer, char *separator, struct string_buffer *before, struct string_buffer *after);
    //@ requires [?f1]string_buffer(buffer, ?bcs) &*& [?f2]chars(separator, ?n, ?cs) &*& mem('\0', cs) == true &*& string_buffer(before, _) &*& string_buffer(after, _);
    //@ ensures [f1]string_buffer(buffer, bcs) &*& [f2]chars(separator, n, cs) &*& string_buffer(before, _) &*& string_buffer(after, _);
