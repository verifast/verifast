 ...
 * @param tewt the text that may represent an annotation. This method assumes
 * that the given tewt is a valid C++ comment.
 * @param newSeq whether or not this annotaion starts a new sequence.
