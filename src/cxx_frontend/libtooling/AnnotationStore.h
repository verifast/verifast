...
class AnnotationStore {
  ...
  struct AnnCont {
     ...
     * annotation conatiner, are added to.
    ...
    /**
     * Retrieves all annotations in this annotaion container and adds them to
     * the given container.
...
public:
   ...
   * can pass the the lcoation of the start of the body. Otherwise an attempt
