...
class smtlib_context input_fun output (features : string list) =
  ...
  object
    ...
    val c_div_sym = Smtlib.Sym.fresh "c_div" [Smtlib.Sort.int; Smtlib.Sort.int] Smtlib.Sort.int
    val c_mod_sym = Smtlib.Sym.fresh "c_mod" [Smtlib.Sort.int; Smtlib.Sort.int] Smtlib.Sort.int
    method mk_div = Smtlib.bapp c_div_sym
    method mk_mod = Smtlib.bapp c_mod_sym
