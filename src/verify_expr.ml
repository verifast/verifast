...
module VerifyExpr(VerifyProgramArgs: VERIFY_PROGRAM_ARGS) = struct
  ...
  and assigned_variables s =
    ...
    | PerformActionStmt (lcb, is_atomic, nonpure_ctxt, bcn, pre_boxargs, lch, pre_handlepredname, pre_handlepredargs, lpa, actionname, actionargs, body, closeBraceLoc, post_boxargs, posthandles) ->
  ...
  let assume_is_of_type l t tp cont =
    ...
    | UShortType _ -> assume (ctxt#mk_and (ctxt#mk_le min_ushort_term t) (ctxt#mk_le t max_ushort_term)) cont
