...
*)
  ...
  object
    ...
    val c_div_sym = Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "/") [| int_type; int_type |] int_type
    val c_mod_sym = Z3.mk_func_decl ctxt (Z3native.mk_string_symbol ctxt "%") [| int_type; int_type |] int_type
    method mk_div t1 t2 = Z3.mk_app ctxt c_div_sym [| t1; t2 |]
    method mk_mod t1 t2 = Z3.mk_app ctxt c_mod_sym [| t1; t2 |]
